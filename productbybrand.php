...
<?php
if(!isset($_GET['pbo']) && $_GET['pbo']==NULL){
			...
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_items-->
                       ...
                       $getpd = $pd->showBrandProductById($brandid,$start_from, $num_rec_per_page);
                       if($getpd){
				  ...
				  ?>
						<div class="col-sm-4">
							...
							<?php } }else{
								   echo "<span style='color:#7AB733;text-align:center;text-transform:uppercase;margin:20px;margin-bottom:40px;'><h3>No Products Are Available</h3></span>";
								}?>	
						
					</div><!--features_items-->
						<?php
		                $gr = $pd->productPaginationInBrand($brandid);
						...
						<ul class="pagination">
						<?php
						echo "<li class=\"active\"><a href='?pbo=".$brandid."&page=1'>".'<<'."</a></li>"; // Goto 1st page
						for ($i=1; $i<=$total_pages; $i++) { 
                         echo "<li class=";
                          if(isset($_GET['page'])&& $_GET['page']==$i)
                          	echo 'active';
                         echo "><a href='?pbo=".$brandid."&page=".$i."'>".$i."</a></li>";
                    } 
                    echo "<li class=\"active\"><a href='?pbo=".$brandid."&page=$total_pages'>".'>>'."</a></li>"; // Goto last page
                    ?>
						</ul>
				</div>
			</div>
