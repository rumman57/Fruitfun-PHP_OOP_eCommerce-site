...
include '../classes/Brand.php';  
    $brand = new Brand();
  if(!isset($_GET['brandedit']) && $_GET['brandedit']==NULL){
     echo "<script>window.location='showcat.php'</script>";
  }else{
     $brandedit = $_GET['brandedit'];
  }
  if($_SERVER['REQUEST_METHOD'] == 'POST')
    {
      $brandName = $_POST['brandName'];
      $catupdatemsg = $brand->updateBrandById($brandedit,$brandName);
    }
?>
        ...
        <div class="col-md-12">
          <div class="box box-info">
            ...
            <div class="box-body pad">
             <?php
                  $getcat = $brand->getBrandById($brandedit);
