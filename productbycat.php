...
<?php
if(!isset($_GET['pbc']) && $_GET['pbc']==NULL){
			...
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_items-->
                       ...
                       $getpd = $pd->showCatProductById($catid,$start_from, $num_rec_per_page);
                       if($getpd){
				  ...
				  ?>
						...
						<?php
		                $gr = $pd->productPaginationInCat($catid);
						...
						<ul class="pagination">
						<?php
						echo "<li class=\"active\"><a href='?pbc=".$catid."&page=1'>".'<<'."</a></li>"; // Goto 1st page
						for ($i=1; $i<=$total_pages; $i++) { 
                         echo "<li class=";
                          if(isset($_GET['page'])&& $_GET['page']==$i)
                          	echo 'active';
                         echo "><a href='?pbc=".$catid."&page=".$i."'>".$i."</a></li>";
                    } 
                    echo "<li class=\"active\"><a href='?pbc=".$catid."&page=$total_pages'>".'>>'."</a></li>"; // Goto last page
                    ?>
						</ul>
				</div>
			</div>
